                    ...
                    <div class="bg-white border border-slate-200 rounded-2xl w-full max-w-2xl p-8 relative transform scale-95 transition-transform duration-300 shadow-2xl">
                        ...
                        <div class="text-center">
                            ...
                            <div class="space-y-4">
                                ...
                                <!-- Phone Link -->
                                <a href="tel:3364628375" class="flex items-center gap-4 p-4 rounded-xl bg-slate-50 border border-slate-200 hover:bg-white hover:border-primary/50 hover:shadow-lg transition-all group">
                                    <div class="w-10 h-10 bg-slate-200 rounded-full flex items-center justify-center group-hover:bg-primary group-hover:text-black transition-colors">
                                    ...
                                    <div class="text-left">
                                        ...
                                        <div class="font-bold text-xl text-slate-900">(336) 462-8375</div>
                                    </div>
                                </a>
                            </div>
                        </div>
