export function loadHeader() {
    ...
    <div id="mobile-menu-overlay" class="fixed inset-0 z-[90] bg-gradient-to-b from-white to-blue-100/90 backdrop-blur-xl transform translate-x-full transition-transform duration-500 ease-in-out md:hidden flex flex-col items-center justify-start pt-32 overflow-y-auto opacity-0 pointer-events-none">
        <div class="flex flex-col items-center gap-8 text-2xl font-mono font-bold uppercase tracking-widest text-slate-900 w-full pb-10">
            ...
            <a href="tel:3364628375" class="flex items-center justify-center gap-2 text-slate-900 bg-slate-100 border border-slate-200 px-8 py-3 rounded-full mt-4 w-full shadow-sm active:scale-95 transition-all text-sm font-bold tracking-widest uppercase">
                <span class="material-icons-round">phone</span>
                (336) 462-8375
            </a>
            <button data-trigger="modal" class="mobile-link text-white border border-transparent px-8 py-3 rounded-full mt-4 bg-slate-900 shadow-lg active:scale-95 transition-all w-full">
                Contact
            </button>
        </div>
    </div>
